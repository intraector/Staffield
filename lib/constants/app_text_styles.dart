...
class AppTextStyles {
  ...
  static TextStyle get bodyBold =>
      TextStyle(fontSize: AppFonts.body, color: AppColors.primary, fontWeight: FontWeight.bold);
  static TextStyle get bodyBoldLight =>
      TextStyle(fontSize: AppFonts.body, color: Colors.white, fontWeight: FontWeight.bold);
